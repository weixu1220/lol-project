...
function MyChamps() {
  ...
  const displayItems = [];
  let placeholderUrl =
    "https://ddragon.leagueoflegends.com/cdn/13.14.1/img/champion/Aatrox.png";
  ...
  for (let item of myChamps) {
    ...
    displayItems.push(
      <div
        className="flex-col w-48 h-64 justify-center border-2 p-5 m-5 rounded-xl hover:shadow-2xl"
        key={champName}
      >
        <div
          className="flex-col justify-center"
          onClick={() => navigate(`/champions/${champName}`)}
        >
          <img
  ...
  return (
    <div className="flex flex-col">
      <button
        className="border-2 rounded-md text-amber-400 text-xl text-center p-3 mt-10 mx-auto bg-blue-950"
        onClick={handleResetChamps}
      >
        Reset My Champs
      </button>
